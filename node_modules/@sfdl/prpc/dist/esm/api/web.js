...
var WebApi = /** @class */ (function () {
    ...
    WebApi.prototype.init = function (apiConfig, onResponse) {
    ...
    WebApi.prototype.handler = function (method, value) {
        return __awaiter(this, void 0, void 0, function () {
            var serializer, jsonValue, formData, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.config) {
                        ...
                        jsonValue = JSON.stringify(value, serializer.serializer);
                        ...
                        return [4 /*yield*/, fetch(this.config.options.url, {
                                method: 'POST',
                                body: formData,
                            })];
                    case 1:
                    ...
                    case 3: throw "Server responded with error: ".concat(response.status);
                }
            });
        });
    };
