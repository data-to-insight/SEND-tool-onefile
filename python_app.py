...
def html_plot(plot, width):
    ...
    if width == "n":
        plot = plot.to_html(include_plotlyjs=False, full_html=False, default_height="350px", default_width="575px")
    if width == "w":
        plot = plot.to_html(include_plotlyjs=False, full_html=False, default_height="350px", default_width="1200px")
    return plot
