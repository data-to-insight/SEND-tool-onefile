...
def html_plot(plot, width):
    ...
    if width == "n":
        plot = plot.to_html(include_plotlyjs=False, full_html=False, default_height="400px", default_width="650px")
    if width == "w":
        plot = plot.to_html(include_plotlyjs=False, full_html=False, default_height="400px", default_width="1300px")
    return plot
